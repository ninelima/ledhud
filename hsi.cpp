...
void GLHSI::renderFixedMarkers()
{
  ...
  QFont font("Fixed", 12, QFont::Bold);
	...
	// Magnetic Heading
	qglColor( QColor( "white" ) );
  //t = (QString( "%1" ).arg( magHeading ));
  t = (QString( "%1" ).sprintf("%03d", magHeading ));
  ...
  font.setPointSize( 10 );
    ...
    t = (QString( "%1" ).sprintf("%03d", gpsCourse ));
  else
		t = "---";
	t = t.rightJustify(3,' ');
	QGLWidget::renderText ( textLeftPix, textBottomPix, t, font, 2000 ) ;
  ...
  font.setPointSize( 10 );
    ...
    t = (QString( "%1" ).sprintf("%03d", navCourse ));
  else
		t = "---";
	t = t.rightJustify(3,' ');
	QGLWidget::renderText ( textLeftPix, textBottomPix, t, font, 2000 ) ;
...
void GLHSI::renderCompassRose()
{
	...
	z = 1.0;
	qglColor( QColor( "white" ) );
	//b2 QFont font("Fixed", 12, QFont::Bold);
	QFont font("Fixed", 12, QFont::Normal);
	QFontMetrics fm = fontMetrics();
  ...
  for (i = 0; i <= 330; i=i+30) {
    ...
    sinI = isin( (GLfloat)((450-i) % 360)  );
    cosI = icos( (GLfloat)((450-i) % 360)  );
    ...
    QGLWidget::renderText ( .75 * roseRadius * cosI, .75 * roseRadius * sinI, z, t, font, 2000 ) ;
...
void GLHSI::decBugHeading( )
{
  ...
  //b2 if ( bugHeading < 0 ) bugHeading = bugHeading + 360;
  //updateGL();

  bugHeading--;
  bugHeading %= 360;
  while (bugHeading < 0) bugHeading += 360;
  updateGL();
...
void GLHSI::testHSI()
{
	...
	int r;
	//b2 TestHSI testhsi( this,0,TRUE,Qt::WStyle_Customize|Qt::WStyle_DialogBorder|Qt::Qt::WStyle_StaysOnTop);
	TestHSI testhsi( this,0,TRUE);									//,Qt::WStyle_Customize|Qt::WStyle_DialogBorder|Qt::WStyle_StaysOnTop);
...
: QDialog( parent, name, modal, f )
{
	...
	QSlider* magHeadingSlider = new QSlider ( 0, 720, 60, 360, Qt::Horizontal, this, "magHeadingSlider" );

	magHeadingSlider->setTickmarks( QSlider::TicksAbove);
	...
	QSlider* gpsCourseSlider = new QSlider ( 0, 720, 60, 390, Qt::Horizontal, this, "gpsCourseSlider" );
	gpsCourseSlider->setTickmarks( QSlider::NoTicks );
	...
	QSlider* gpsDeviationSlider = new QSlider ( -15, 15, 2, 1, Qt::Horizontal, this, "gpsDeviationSlider" );
	gpsDeviationSlider->setTickmarks( QSlider::NoTicks );
	...
	QSlider* navCourseSlider = new QSlider ( 0, 720, 60, 330, Qt::Horizontal, this, "navCourseSlider" );
	navCourseSlider->setTickmarks( QSlider::NoTicks );
	...
	QSlider* navDeviationSlider = new QSlider ( -15, 15, 2, -3, Qt::Horizontal, this, "navDeviationSlider" );
	navDeviationSlider->setTickmarks( QSlider::NoTicks );
	...
	QSlider* ilsDeviationSlider = new QSlider ( -15, 15, 2, 1, Qt::Horizontal, this, "ilsDeviationSlider" );
	ilsDeviationSlider->setTickmarks( QSlider::NoTicks );
	...
	Q3GridLayout* gridLayout = new Q3GridLayout( this, 6, 2, 10, 10, "gridLayout");
